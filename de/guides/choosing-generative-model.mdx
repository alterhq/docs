...
Alter bietet Zugriff auf **92+ Modelle von 10 Anbietern** über seinen einheitlichen Router. Verwenden Sie den `/models`-Endpunkt, um die aktuellen Modelle aufzulisten, oder sehen Sie sich den **[API Gateway Guide](/de/guides/api-gateway)** für detaillierte Modellinformationen an.
...
Oder sehen Sie den **[API Gateway Guide](/de/guides/api-gateway)** für detaillierte Informationen zur Modellauswahl und -verwendung.
