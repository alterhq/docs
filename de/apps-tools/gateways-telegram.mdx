...
<Steps>
  ...
  <Step title="Choose Standardaktion">
    **Ask Anything** is the default and works on Telegram out of the box. For a custom action, add `telegram` or `*` under **Action Editor → Model → Gateways → Erlaubte Gateways**.
  </Step>
