...
- [Auswahl von KI-Modellen](/de/guides/choosing-generative-model) – Vergleich von lokalen und Cloud-Optionen
- [Einstellungen von API-Schlüsseln](/de/guides/settings#external-api-keys) – Detaillierte Konfiguration
