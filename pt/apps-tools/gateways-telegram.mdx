...
<Steps>
  ...
  <Step title="Fill in Connection fields">
    ...
    Uma ligação **Guia de configuração Telegram gateway** no final da secção Connection abre esta página no browser.
  </Step>
  <Step title="Choose Ação predefinida">
    **Ask Anything** é a predefinição e funciona no Telegram de imediato. Para action personalizada, defina **Disponibilidade** como **Telegram** ou **Todos** em **Action Editor → Gateways**.
  </Step>
