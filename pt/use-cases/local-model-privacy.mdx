...
- [Choosing AI models](/how-to/choose-generative-model) – Compare opções locais vs nuvem
- [Configurações das teclas API](/how-to/settings-guide#external-api-keys) – Configuração detalhada
