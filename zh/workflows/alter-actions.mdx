...
- [Tools 与集成](/apps-tools/integrations-overview) — Available tools for your actions
- [URL Callbacks](/workflows/url-callbacks) — Deep dive into x-callback-url automation
- [语音和听写](/workflows/dictation) — Set up voice triggers
- [设置](/how-to/settings-guide) — Configure global model and voice settings
