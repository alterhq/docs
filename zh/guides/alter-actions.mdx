---
title: "Alter 行动"
description: "通过语音触发和自动化创建和配置自定义 AI 工作流程"
---
...
- [Tools 与集成](/guides/integrations) — Available tools for your actions
- [URL Callbacks](/guides/url-callbacks) — Deep dive into x-callback-url automation
- [语音和听写](/guides/dictation) — Set up voice triggers
- [设置](/guides/alter-settings) — Configure global model and voice settings
