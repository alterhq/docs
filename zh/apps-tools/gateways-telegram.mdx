...
<Steps>
  ...
  <Step title="Choose 默认 Action">
    **Ask Anything** is the default and works on Telegram out of the box. For a custom action, add `telegram` or `*` under **Action Editor → Model → Gateways → 允许的 Gateways**.
  </Step>
...
- [Alter Actions — 允许的 Gateways](/workflows/alter-actions)
