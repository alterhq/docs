...
不选择其他操作时，Alter 运行 **Ask Anything**。**2.0.0-beta100** 起默认包含 **Flow**、**Computer Use** 和 **Ask User**。

自定义：**Action Editor**（**⌘⇧E**）→ **Ask Anything** → **Tools**。

见 [Flow 编排](/workflows/use-flow-orchestration#ask-anything-defaults-beta100)。
