...
<AccordionGroup>
  <Accordion icon="download" title="Download Alter">
    Download Alter from our [website](https://alterhq.com/beta).
...
<AccordionGroup>
  ...
  <Accordion icon="keyboard" title="Configure your hotkeys">
    In **Settings → Shortcuts → Global**:
    
    - Set **Open QuickHub** (or **Open notch** if QuickHub Mode is off) — default: **⌘⇧Space**
    - Configure other global shortcuts (Hub, New Hub Chat, dictation) as needed
    
    In **Settings → General**, enable the **Selection Button** for quick access when selecting text.
  </Accordion>
</AccordionGroup>
