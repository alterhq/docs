...
Choose whether this action is available from **Discord** and **Telegram** Gateways.
...
| **Discord** | Available from Discord gateways |
| **Telegram** | Available from Telegram gateways |
| **All** | Available from every gateway |

The bundled **Ask Anything** action defaults to **All**. Custom actions start on **None** until you enable a platform or **All**. Set Ask Anything to **None** if you want it local-only.
