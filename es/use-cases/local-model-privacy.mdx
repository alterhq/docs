...
- [Elección de modelos de IA](/guides/choosing-generative-model) – Comparar opciones locales versus opciones en la nube
- [Configuración de claves API](/guides/settings#external-api-keys) – Configuración detallada
