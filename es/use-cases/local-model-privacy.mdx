...
<AccordionGroup>
  <Accordion icon="gauge" title="Velocidad versus privacidad">
...
Una MacBook Pro con 16 GB de RAM puede ejecutar modelos pequeños sin problemas. Para modelos más grandes, querrás más de 32 GB de RAM.
  ...
  <Accordion icon="brain" title="Diferencias de capacidad">
...
**Mejor enfoque:** Utilice modelos locales para datos confidenciales y modelos en la nube para tareas complejas menos confidenciales.
  ...
  <Accordion icon="hard-drive" title="Requisitos de almacenamiento">
...
- [Elección de modelos de IA](/how-to/choose-generative-model) – Comparar opciones locales versus opciones en la nube
- [Configuración de claves API](/how-to/settings-guide#external-api-keys) – Configuración detallada
