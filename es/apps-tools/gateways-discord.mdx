...
<Steps>
  ...
  <Step title="Elegir Acción predeterminada y comportamiento de hilos">
    **Ask Anything** es la predeterminada y funciona en Discord de inmediato. Para una acción personalizada, añade `discord` o `*` en **Action Editor → Model → Gateways → Gateways permitidos**.
