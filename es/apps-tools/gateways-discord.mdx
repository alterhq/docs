...
<Steps>
  ...
  <Step title="Comprobar formato de búsqueda web">
    Cuando la action activa usa búsqueda web, las respuestas en Discord incluyen enlaces de fuente claramente formateados en lugar de markup sin procesar.
  </Step>
