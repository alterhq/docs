...
<CardGroup cols={3}>
  ...
  <Card title="Keyboard Shortcut" icon="keyboard">
    Press **⌘⇧Space** (or your custom hotkey)
  </Card>
...
<Steps>
  <Step title="Use the default shortcut">
    Press **⌘⇧Space** to open QuickHub (or the notch if QuickHub Mode is off)
  </Step>
...
<Note>
  **Customize your shortcut:** Go to **Settings → Shortcuts → Global** and edit **Open QuickHub** (or **Open notch**).
</Note>
...
<Note>
  **Configure voice settings:** Go to **Settings → Voice** (Shortcuts section) to customize your voice hotkey.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Window Types" icon="window" href="/getting-started/window-types-notch-hub-panels">
    Learn about the Hub and QuickHub interfaces
  </Card>
