...
- [Choisir des modèles d'IA](/fr/how-to/choose-generative-model) – Comparez les options locales et cloud
- [Paramètres des clés API](/fr/how-to/settings-guide#external-api-keys) – Configuration détaillée
