...
<Steps>
  ...
  <Step title="Check web search formatting">
    When the active action uses web search, Discord replies include clearly formatted source links instead of raw markup.
  </Step>
  <Step title="Try /new">
