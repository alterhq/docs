...
<Steps>
  ...
  <Step title="Fill in Connection fields">
    ...
    A **Telegram gateway setup guide** link at the bottom of the Connection section opens this page in your browser.
  </Step>
  <Step title="Choose Default action">
    **Ask Anything** is the default and works on Telegram out of the box. For a custom action, set **Availability** to **Telegram** or **All** under **Action Editor → Gateways**.
  </Step>
